...
(function () {
    ...
    overlay.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#e8a020" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:20px">
            <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
        <h1 style="color:#ffffff;font-size:clamp(1.4rem,4vw,2rem);font-weight:700;margin:0 0 12px">Scheduled Maintenance</h1>
        <p style="color:#aaaaaa;font-size:clamp(0.9rem,2.5vw,1.05rem);max-width:480px;line-height:1.7;margin:0 0 32px">
            We're currently performing scheduled maintenance on our website.<br>
            We'll be back up shortly — thank you for your patience.
        </p>
        <p style="color:#cccccc;font-size:clamp(0.85rem,2vw,0.95rem);margin:0 0 10px">Need to schedule an appointment? Give us a call:</p>
        <a href="tel:5104908883" style="color:#e8a020;font-size:clamp(1.1rem,3vw,1.4rem);font-weight:600;text-decoration:none;letter-spacing:0.5px">(510) 490-8883</a>
    `;

    // Block all interaction with the page beneath
